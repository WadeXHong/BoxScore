...
public class HistoryPlayersDataStatisticAdapter extends LinkedAdaptiveTableAdapter<ViewHolderImpl> {
    ...
    private class ColumnViewHolder extends ViewHolderImpl {
        ...
        private TextView mColumnHeaderTextView;

        public ColumnViewHolder(@NonNull View itemView) {
            super(itemView);
            mColumnHeaderTextView = itemView.findViewById(R.id.item_datastatistic_textview);
        }

        private void bind(int column) {

            mColumnHeaderTextView.setText(Constants.COLUMN_NAME_SPARSE_ARRAY.get(Constants.COLUMN_NAME_SPARSE_ARRAY.keyAt(column)));
    ...
    private class RowViewHolder extends ViewHolderImpl {
        ...
        private TextView mRowHeaderTextView;

        public RowViewHolder(@NonNull View itemView) {
            super(itemView);

            mRowHeaderTextView = itemView.findViewById(R.id.item_datastatistic_textview);
        }
